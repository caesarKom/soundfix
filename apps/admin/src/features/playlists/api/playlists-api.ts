...
import type { AdminPlaylist, CreatePlaylistDto } from '../types/playlists.ts';
...
export const playlistsApi = {
  ...
  create: async (dto: CreatePlaylistDto): Promise<AdminPlaylist> => {
    const { data } = await apiClient.post<AdminPlaylist>('/playlists', dto);
    return data;
  },
